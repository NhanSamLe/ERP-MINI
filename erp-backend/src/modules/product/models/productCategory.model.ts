...
export class ProductCategory extends Model<ProductCategoryAttrs, ProductCategoryCreation>
...
ProductCategory.init(
  ...
  { sequelize, tableName: "product_categories", timestamps: true, createdAt: "created_at", updatedAt: "updated_at" }
);
