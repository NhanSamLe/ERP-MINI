...
export async function createManualEntry(
  ...
  // 3. Tạo mã bút toán JV duy nhất theo cơ chế sequence tự tăng hàng ngày
...
export async function getTrialBalance(filter: { from: string; to: string; branch_id?: number; excludeClosing?: boolean }) {
