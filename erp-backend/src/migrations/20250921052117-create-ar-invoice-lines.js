...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('ar_invoice_lines', {
    ...
    await queryInterface.addConstraint('ar_invoice_lines', {
      fields: ['invoice_id'],
      type: 'foreign key',
      name: 'fk_ar_invoice_lines_invoice',
    ...
    await queryInterface.addConstraint('ar_invoice_lines', {
      fields: ['product_id'],
      type: 'foreign key',
      name: 'fk_ar_invoice_lines_product',
  ...
  async down(queryInterface) {
    await queryInterface.dropTable('ar_invoice_lines');
  }
};
