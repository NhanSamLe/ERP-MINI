  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
      <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
        ...
        Nhân sự và dòng thời gian
      </h3>
      <div className="space-y-4">
        <div>
          <p className="text-gray-500 text-sm mb-2">Người tạo</p>
        ...
        {order.approver && (
          <div>
            <p className="text-gray-500 text-sm mb-2">Người phê duyệt</p>
            <div className="bg-green-50 rounded-lg p-3 border border-green-200">
              <p className="text-gray-900 font-semibold">
                {order.approver?.full_name}
              </p>
              <p className="text-gray-500 text-xs mt-1">
                {order.approved_at ? formatDate(order.approved_at) : "Không có"}
              </p>
            </div>
          </div>
        )}
        ...
        {order.reject_reason && (
          <div>
            <p className="text-gray-500 text-sm mb-2">Lý do từ chối</p>
