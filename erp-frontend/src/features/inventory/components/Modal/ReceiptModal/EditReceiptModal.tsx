    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-full sm:max-w-4xl max-h-[85vh] overflow-y-auto">
        <DialogHeader className="pb-4 border-b border-slate-100 flex flex-row items-center gap-3">
          ...
          <div>
            <DialogTitle className="text-lg font-bold text-slate-900">Sửa phiếu nhập kho</DialogTitle>
            <DialogDescription className="text-xs text-slate-400 mt-0.5">
              Chỉnh sửa nguyên vật liệu hoặc sản phẩm nhận được từ các đơn mua hàng
            </DialogDescription>
          </div>
        </DialogHeader>
