    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-2 text-sm">
              Tổng cộng: <span className="font-semibold text-gray-700">{totalItems}</span> bản ghi
            </p>
          </div>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            placeholder="Tìm theo nhân viên, trạng thái, ghi chú..."
                  ...
                  <td colSpan={10} className="px-6 py-16">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 text-sm font-medium">
                        {search ? "Không tìm thấy kết quả phù hợp" : "Không có dữ liệu chấm công"}
                      </p>
                      <p className="text-gray-400 text-xs mt-1">
                        {search
                          ? "Hãy thử tìm kiếm với từ khóa khác"
                          : "Bấm 'Thêm bản ghi chấm công' để tạo mới bản ghi"}
                      </p>
                    </div>
                  </td>
                </tr>
