...
const GlEntryListPage: React.FC = () => {
  ...
  const title = useMemo(() => `Bút toán sổ nhật ký #${jid}`, [jid]);
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600">Tổng số: <span className="font-semibold text-slate-900">{stats.total}</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                  <span className="text-slate-600">Đã ghi sổ: <span className="font-semibold text-emerald-700">{stats.posted}</span></span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-amber-500 rounded-full"></div>
                  <span className="text-slate-600">Nháp: <span className="font-semibold text-amber-700">{stats.draft}</span></span>
                </div>
              </div>
            </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Số chứng từ, Diễn giải, Tham chiếu..."
                    value={search}
                  ...
                  <tr>
                    <td className="px-6 py-16 text-center" colSpan={5}>
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div>
                          <p className="text-slate-900 font-semibold mb-1">Không có bút toán nào</p>
                        ...
                        {r.reference_type ? (
                          <div className="flex flex-col">
                            <span className="text-xs font-bold text-blue-600 uppercase">
                              {r.reference_type === "ar_invoice" || r.reference_type === "AR_INVOICE" ? "Hóa đơn bán hàng" : "Hóa đơn mua hàng"}
                            </span>
