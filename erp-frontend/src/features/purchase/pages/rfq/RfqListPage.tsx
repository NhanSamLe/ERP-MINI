...
import { Plus, RotateCw, GitCompare, FileText, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div className="erp-card overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-5 py-3 border-t border-orange-100 bg-orange-50/30 gap-3 text-sm text-gray-600">
          <p className="text-xs text-gray-500">
            ...
            <strong>{filtered.length}</strong> yêu cầu (Tổng cộng <strong>{items.length}</strong> bản ghi)
          </p>
