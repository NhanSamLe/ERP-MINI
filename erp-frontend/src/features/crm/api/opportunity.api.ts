...
export const moveToNegotiation = (oppId: number) => {
  return axiosClient.patch("/crm/opportunities/negotiation", { oppId });
}
export const markWon = (oppId: number) => {
  return axiosClient.patch("/crm/opportunities/won", { oppId });
}
export const markLost = (oppId: number, reason: string) => {
  return axiosClient.patch("/crm/opportunities/lost", { oppId, reason });
}

export const reassignOpportunity = (oppId: number, newUserId: number) => {
  return axiosClient.patch("/crm/opportunities/reassign", { oppId, newUserId });
}
